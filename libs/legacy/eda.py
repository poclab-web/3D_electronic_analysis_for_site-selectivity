...
if __name__ == "__main__":
    ...
    ddg = plot_origin_regression_series(
        series_data,
        "data/legacy/eda/comparison_A.png",
    ...
    ddg = plot_origin_regression_series(
        series_data,
        "data/legacy/eda/comparison_B.png",
        text_positions=text_pos,
    )
    print(ddg)
    ...
    ddg = plot_origin_regression_series(
        series_data,
        "data/legacy/eda/comparison_C.png",
        text_positions=text_pos,
    )
    print(ddg)

    plot_dft_bar_dual("data/legacy/eda/DFT.png")
    plot_diketone_reduction_stackplot(
        "data/Details_of_experimental_results.xlsx",
        "data/legacy/eda/reaction_rate_stackplot.png",
    )
